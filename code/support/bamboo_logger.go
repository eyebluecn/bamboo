...
func (this *BambooLogger) Destroy() {
	this.closeFile()
}

//uniform log method
func (this *BambooLogger) Log(prefix string, format string, v ...interface{}) {
...
func (this *BambooLogger) Debug(format string, v ...interface{}) {
	this.Log("[DEBUG]", format, v...)
}

func (this *BambooLogger) Info(format string, v ...interface{}) {
	this.Log("[INFO ]", format, v...)
}

func (this *BambooLogger) Warn(format string, v ...interface{}) {
	this.Log("[WARN ]", format, v...)
}

func (this *BambooLogger) Error(format string, v ...interface{}) {
	this.Log("[ERROR]", format, v...)
}

func (this *BambooLogger) Panic(format string, v ...interface{}) {
...
//rename log file.
func (this *BambooLogger) maintain() {
	...
	destPath := util.GetLogPath() + "/bamboo-" + util.ConvertTimeToDateString(util.Yesterday()) + ".log"
	...
	oldDestPath := util.GetLogPath() + "/bamboo-" + util.ConvertTimeToDateString(monthAgo) + ".log"
...
//log file name
func (this *BambooLogger) fileName() string {
	return util.GetLogPath() + "/bamboo.log"
}

//open log file
func (this *BambooLogger) openFile() {
...
//close log file.
func (this *BambooLogger) closeFile() {
	if this.file != nil {
		err := this.file.Close()
		if err != nil {
