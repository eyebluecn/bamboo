...
//catch global panic.
func (this *BambooRouter) GlobalPanicHandler(writer http.ResponseWriter, request *http.Request, startTime time.Time) {
...
func (this *BambooRouter) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
